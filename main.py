...
def main():
    ...
    # Separate lists for each agent's generated queries
    ...
    simpleAgent.initialize_q_table(len(queries))  # Assuming each query is a state
    ...
    generated_queries_dqnAgent_df.to_csv("generated_queries_dqnAgent.csv", index=False)
    print(
    ...
    generated_queries_simpleAgent_df.to_csv(
        "generated_queries_simpleAgent.csv", index=False
    )
    print(
