...
def main():
    ...
    generated_queries_dqnAgent_df.to_csv("generated_queries_Agent1.csv", index=False)
    print(
    ...
    generated_queries_simpleAgent_df.to_csv("generated_queries_Agent2.csv", index=False)
    print(
